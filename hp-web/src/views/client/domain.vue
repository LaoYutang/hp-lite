<template>
  <div>
    ...
    <a-button type="primary" style="margin-bottom: 10px; margin-left: 5px" @click="loadData"
      >刷新</a-button
    >
  ...
  <div>
    <a-modal okText="确定" cancelText="取消" v-model:visible="addVisible" title="信息" @ok="addOk">
